    ...
    <div class="min-w-[735px]">
      ...
      >
        ...
        >
          ...
          />
          <AppLink
            :to="vote.validator?.validator?.name ? 
            `https://staking.harmony.one/validators/mainnet/${vote.validator?.validator?.address}` : 
            {
          ...
          >
            ...
            <div class="flex flex-col truncate">
              <h4
                class="truncate"
                v-text="vote.validator?.validator?.name || vote.voter.name || shortenAddress(vote.voter.id)"
              />
              <div
