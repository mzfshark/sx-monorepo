...
const harmonyConfig = createConfig('harmony');
...
const harmonyIndexer = new evm.EvmIndexer(createWriters(harmonyConfig));
export function addEvmIndexers(checkpoint: Checkpoint) {
  // console.log(harmonyConfig.indexerName, harmonyConfig, harmonyIndexer);
  // console.log(baseConfig.indexerName, baseConfig, baseIndexer);

  registerIndexer(checkpoint, harmonyConfig.indexerName, harmonyConfig, harmonyIndexer);
